...
In Domino 5.0, this new data access method is supported for Snowflake, Redshift, PostgreSQL and S3, with additional data sources planned for future releases.
