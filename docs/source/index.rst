...
In Domino 5.1, this new data access method is supported for Snowflake, Redshift, PostgreSQL, MySQL, Oracle, SQL Server and S3, with additional data sources planned for future releases.
