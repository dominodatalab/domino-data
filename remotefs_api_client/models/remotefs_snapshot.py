...
class RemotefsSnapshot(object):
    ...
    def __init__(self, created_at=None, created_by=None, description=None, id=None, labels=None, last_mounted_time=None, run_id=None, status=None, updated_at=None, updated_by=None, version=None, volume_id=None):  # noqa: E501
