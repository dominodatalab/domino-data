...
class RemotefsVolumeMount(object):
    ...
    def __init__(self, can_user_write=None, name=None, persistent_volume_claim_name=None, snapshot_sub_path=None, sub_path=None, volume_id=None):  # noqa: E501
    ...
    def snapshot_sub_path(self, snapshot_sub_path):
        ...
        if snapshot_sub_path is None:
            raise ValueError("Invalid value for `snapshot_sub_path`, must not be `None`")  # noqa: E501
